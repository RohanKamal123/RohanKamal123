...
<!-- PORTRAIT - dot-matrix render of the GitHub avatar, generated by
     scripts/dotify.py. Mono-green so one file serves both themes. Regenerate:
       python scripts/dotify.py assets/avatar.png -o assets/portrait \
         --cols 46 --detail 1.0 --gap 0.15 -->
<img src="assets/portrait.svg" width="220" alt="Tahsin Kamal Rohan, rendered as a dot matrix">
